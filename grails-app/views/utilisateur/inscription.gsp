    ...
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            <g:form name="formInscription" url="[controller:'utilisateur',action:'inscriptionPost']">
                <h2 id="page-header">Inscription <small>Totalement gratuit, pour toujours.</small></h2>
                <hr class="colorgraph">
                <div class="row">
                ...
                <hr class="colorgraph">
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-md-offset-6"><input type="submit" value="M'inscrire" id="btnInscription" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
                </div>
            </g:form>
        </div>
    </div>
